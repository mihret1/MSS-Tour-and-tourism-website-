...
<>
    ...
    <div  className={`  ${showColor? "bg-white":"bg-transparent"}  ${showColor && "fixed"} ${showColor && "shadow-lg"}  w-[100%]  flex flex-row h-[90px]  items-center  justify-between px-10 max-lg:px-4`}>
      ...
      <button type="button" className={`max-md:hidden md:max-lg:px-5 md:max-lg:py-2 rounded-full hover:bg-gray-600 hover:text-white  ${!showColor ? 'bg-white':'bg-black'} ${!showColor ? 'text-[#8660df]':'text-white '}  py-2 px-7 font-bold text-xl`}>Contact</button>
