...
const BlogDetail=()=>{
        ...
        return(
            <div className="flex h-28  gap-2 items-center border-b-2 pb-4">
              ...
              <div className="flex flex-col justify-items-center  w-3/4">
                ...
                <p className="text-xl font-semibold">{props.desc}</p>
              </div>
            </div>
        )
    }
    return (
        ...
        <h1 className="text-center text-white text-xl font-semibold pt-32"> Latest News <ArrowForwardIosIcon /> Technology for all
           ...
           <div className="flex p-20 max-md:px-5 gap-10  max-lg:flex-col"> 
             <div className=" w-3/5 flex flex-col gap-2 max-lg:w-[100%]">
                    ...
                    <div className="flex flex-col gap-3 pt-10">
                        ...
                        <div className=" flex max-md:flex-col gap-4 justify-between">
                            <TextField  sx={{ width:'50%' ,outlineColor:'#755BB4' }} placeholder="your name..."/> 
                            <TextField sx={{ width:'50%' ,outlineColor:'#755BB4'}} placeholder="email..."/>
                        </div>
                        <textarea
                        className="border-2  outline-[#9e88d1]"
                          ...
                          /> 
                          <button className="w-32 bg-gradient-to-r from-[#755BB4]  to-[#a493ce] text-white text-lg px-5 py-3">Submit</button>
                    </div>
             </div>
             <div className=" w-2/5 max-lg:w-[100%] ">
               <div className="flex">
                <input 
                type="text" 
